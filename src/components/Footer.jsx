...
function Footer() {
    return (
        <div className='flex flex-col bg-gray-800 text-white pt-28 pb-10  rounded-t-full  text-center text-lg md:flex-row md:justify-around'>
            ...
            <div className='mb-10'>
                <ul>
                    <li><a className='text-xl font-bold' href='#home'>Product</a></li>
            ...
            <div className='mb-10'>
                <ul>
                    <li><a className='text-xl font-bold' href='#home'>Company</a></li>
            ...
            <div>
                <ul>
                    <li><a className='text-xl font-bold' href='#home'>Connect</a></li>
